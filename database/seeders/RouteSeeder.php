...
class RouteSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $routes = [
            ...
            ['Gate 2', 'PITX - Tagaytay via Mendez', 'mendez', ['dasma', 'tagaytay', 'mendez']],
            ['Gate 2', 'PITX - Alfonso via Tagaytay', 'alfonso', ['silang', 'tagaytay', 'alfonso']],
            ...
            ['Gate 3', 'Route 2: PITX - Monumento', 'monumento', ['moa', 'buendia', 'monumento']],
            ['Gate 3', 'Route 13: PITX - BGC', 'bgc', ['moa', 'ayala', 'bgc']],
            ['Gate 4', 'PITX - Naga City (Bicol)', 'naga', ['turbina', 'lucena', 'naga']],
            ['Gate 4', 'PITX - Baguio City', 'baguio', ['dau', 'tarlac', 'baguio']],
            ['Gate 5', 'PITX - Batangas City', 'batangas', ['turbina', 'lipa', 'batangas']],
            ['Gate 5', 'PITX - Santa Cruz, Laguna', 'sta_cruz', ['alabang', 'calamba', 'sta_cruz']],
            ['Gate 5', 'PITX - Lucena City, Quezon', 'lucena', ['turbina', 'san_pablo', 'lucena']],
            ...
            ['Gate 7', 'PITX - Tanza', 'tanza', ['kawit', 'noveleta', 'tanza']],
            ['Gate 7', 'PITX - Dasmariñas (KB)', 'dasma', ['bacoor', 'imus', 'dasma']],
            ['Gate 7', 'PITX - Buendia', 'buendia', ['moa', 'taft', 'buendia']],
            ['Gate 7', 'PITX - Taft Avenue', 'taft', ['moa', 'baclaran', 'taft']],
            ['Gate 7', 'PITX - Nichols', 'nichols', ['moa', 'baclaran', 'nichols']],
            ['Gate 7', 'PITX - Sucat', 'sucat', ['baclaran', 'zapote', 'sucat']],
            ['Gate 7', 'PITX - Lawton', 'lawton', ['moa', 'buendia', 'lawton']],
            ['Gate 7', 'PITX - SM Southmall', 'southmall', ['baclaran', 'zapote', 'southmall']],
            ['Gate 10', 'EDSA Busway: PITX - Monumento', 'monumento', ['moa', 'ayala', 'ortigas', 'cubao', 'monumento']],
        ];
