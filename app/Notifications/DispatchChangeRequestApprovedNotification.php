...
class DispatchChangeRequestApprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'type' => 'dispatch_change_request_approved',
            'title' => 'Dispatch change request approved',
            'message' => "Your request to change {$this->changeRequest->field_label} for dispatch {$this->changeRequest->dispatch->plate_number} has been approved.",
            ...
            'approved_by_name' => $this->changeRequest->approvedBy->name ?? 'System',
            'approved_by_id' => $this->changeRequest->approved_by,
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("- Applied Value: {$this->changeRequest->requested_value_display}")
            ->line('The dispatch has been updated with your requested change.')
            ->action('View Dispatch', route('dispatches.show', $this->changeRequest->dispatch->id))
