...
import { Plus, Eye, Pencil, Archive } from 'lucide-vue-next';
...
const vehicles = ref<VehicleRow[]>([
    {
        id: 1,
        vehicle_type: { type_name: 'Bus' },
        plate_number: 'ABC-1234',
        company: { company_name: 'PITX Transport Co.' },
        route: { route_name: 'PITX ↔ Alabang' },
    },
    {
        id: 2,
        vehicle_type: { type_name: 'Modern Jeepney' },
        plate_number: 'XYZ-5678',
        company: { company_name: 'Metro Lines' },
        route: { route_name: 'PITX ↔ Taft' },
    },
    {
        id: 3,
        vehicle_type: { type_name: 'Van' },
        plate_number: 'DEF-9012',
        company: { company_name: 'South Shuttle' },
        route: { route_name: 'PITX ↔ Cavite' },
    },
    {
        id: 4,
        vehicle_type: { type_name: 'Bus' },
        plate_number: 'GHI-3456',
        company: { company_name: 'NorthLine Transit' },
        route: { route_name: 'PITX ↔ Quezon City' },
    },
    {
        id: 5,
        vehicle_type: { type_name: 'UV Express' },
        plate_number: 'JKL-7890',
        company: { company_name: 'Express Movers' },
        route: { route_name: 'PITX ↔ Makati' },
    },
]);
