                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <p class="text-sm text-muted-foreground">
                                        Operator dashboard for dispatch, fleet,
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-sm text-amber-700">
                            {{ stats.pending_dispatches }} pending dispatch{{
                                stats.pending_dispatches !== 1 ? 'es' : ''
                            }}, {{ stats.for_verification_vehicles }} vehicle{{
                                stats.for_verification_vehicles !== 1 ? 's' : ''
                            }}
                            for verification,
                            {{ stats.unassigned_vehicles }} unassigned, and
                            {{
                                stats.invalid_documents +
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <CardTitle class="text-base"
                                    >Operations Performance</CardTitle
                                >
                                <CardDescription class="text-xs">
                                    Key indicators for dispatches, fleet, and
                                    routes
                                </CardDescription>
                            </div>
                        </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    ...
                                    <span class="font-semibold text-blue-700"
                                        >{{
                                            stats.dispatch_completion_rate
                                        }}%</span
                                    >
                                </div>
                                <div
                                    class="h-2 w-full overflow-hidden rounded-full bg-blue-100"
                                >
                                    <div
                                        class="h-full rounded-full bg-blue-600 transition-all"
                                        :style="{
                                            width: `${stats.dispatch_completion_rate}%`,
                                        }"
                                    />
                                </div>
                                <p class="text-xs text-muted-foreground">
                                    {{ stats.arrived_dispatches }} arrived of
                                    {{ stats.total_dispatches }} total
                                </p>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                        :style="{
                                            width: `${stats.fleet_readiness_rate}%`,
                                        }"
                                    />
                                </div>
                                <p class="text-xs text-muted-foreground">
                                    {{ stats.active_vehicles }} active of
                            ...
                            <div class="space-y-1.5">
                                ...
                                >
                                    <div
                                        ...
                                        "
                                        :style="{
                                            width: `${stats.route_coverage_rate}%`,
                                        }"
                                    />
                                </div>
                                <p class="text-xs text-muted-foreground">
                                    {{ stats.assigned_vehicles }} vehicles
                                    assigned to routes
                                </p>
                            </div>
                        </div>
                    ...
                    <CardHeader class="pb-2">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                >
                                <CardDescription class="text-xs"
                                    >Document status breakdown</CardDescription
                                >
                            </div>
                        </div>
                    </CardHeader>
                    ...
                    <CardHeader class="pb-3">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <CardTitle class="text-base"
                                        >Recent Dispatch Activity</CardTitle
                                    >
                                    <CardDescription class="text-xs">
                    ...
                    <Card>
                        <CardHeader class="pb-2">
                            <div class="flex items-center gap-2">
                                ...
                                <div>
                                    <CardTitle class="text-base"
                                        >Fleet Status</CardTitle
                                    >
                                    <CardDescription class="text-xs"
                                        >Vehicle readiness
                                        overview</CardDescription
                                    >
                                </div>
                            </div>
                        </CardHeader>
                        ...
                        <CardContent class="space-y-2">
                            <div
                                class="flex items-center justify-between rounded-lg px-3 py-2.5 text-sm hover:bg-slate-50"
                            >
                                <div class="flex items-center gap-2">
                                    <span
                            ...
                            >
                                ...
                                <span class="font-semibold text-amber-700">{{
                                    stats.for_verification_vehicles
                                }}</span>
                            </div>
                        ...
                        <CardHeader class="pb-2">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <CardTitle class="text-base"
                                            >Top Routes</CardTitle
                                        >
                                        <CardDescription class="text-xs"
                                            >Most assigned
                                            vehicles</CardDescription
                                        >
                                    </div>
                                </div>
                                <Button
                                    ...
                                    variant="ghost"
                                    size="sm"
                                    class="h-7 px-2 text-xs text-blue-600 hover:bg-blue-50"
                                >
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            ...
                                            >Assigned vehicles</span
                                        >
                                        <span
                                            class="text-sm font-bold text-blue-700"
                                            >{{ route.vehicles_count }}</span
                                        >
                                    </div>
                                </div>
                            </div>
