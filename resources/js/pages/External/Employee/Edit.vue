...
function submit() {
    form.put(`/employee-users/${props.employee.id}`, { preserveScroll: true })
}
</script>
                    ...
                    <div class="xl:col-span-2">
                        <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                            <div class="border-b border-slate-100 px-6 py-4">
                                ...
                                <p class="mt-0.5 text-xs text-slate-400">Edit the employee details below.</p>
                            </div>
                                ...
                                <div class="grid gap-5 md:grid-cols-2">
                                    ...
                                    <div class="space-y-1.5 md:col-span-2">
                                        ...
                                        <div class="flex h-10 items-center rounded-lg border border-slate-200 bg-slate-50 px-3">
                                            <code class="rounded bg-slate-200 px-1.5 py-0.5 font-mono text-xs font-semibold text-slate-600">
                                                {{ employee.username }}
                                            </code>
                                        </div>
                        ...
                        <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                            ...
                            <div class="divide-y divide-slate-100">
                                ...
                                <div class="flex items-center gap-3 px-5 py-4">
                                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-100 text-sm font-bold uppercase text-blue-700">
                                        {{ initials }}
                                    </div>
                                    <div class="min-w-0">
                                        <p class="truncate text-sm font-semibold text-slate-800">{{ employee.name }}</p>
                                        <code class="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-xs text-slate-500">
                                            {{ employee.username }}
                                        </code>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center justify-between px-5 py-3">
                                    <p class="text-[11px] font-semibold uppercase tracking-widest text-slate-400">Role</p>
                                    <span
                                        v-if="currentRoleName"
                                        :class="['inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-medium', roleColor(currentRoleName).badge]"
                                    >
                                        <Users class="h-3 w-3" />
                        ...
                        <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                            ...
                            <div v-if="roles.length > 0" class="divide-y divide-slate-100">
                                <div
                                    ...
                                    :class="form.role === role.name ? 'bg-blue-50/60' : ''"
                                ...
                                >
                                    ...
                                    <p class="flex-1 text-xs font-semibold" :class="roleColor(role.name).text">
                                        {{ humanize(role.name) }}
                                    </p>
                                    <span
                            ...
                            <div v-else class="px-5 py-4 text-center text-xs text-slate-400">
