                                    ...
                                    <div class="flex justify-end py-1.5 pr-3" @click.stop>
                                        <DropdownMenu>
                                            ...
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem v-if="canResetEmployee && !isOwnAccount(employee)" class="group" @click="openResetDialog(employee)"><RiKey2Line class="h-4 w-4 shrink-0" />Reset Password</DropdownMenuItem>
