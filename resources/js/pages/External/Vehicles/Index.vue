            ...
            <div class="mx-auto max-w-7xl space-y-6 p-4 md:p-8">
                ...
                >
                    ...
                    <div class="flex items-center gap-2">
                        <Badge
                            variant="outline"
                            class="hidden rounded-lg border-slate-200 bg-slate-50 text-[11px] font-semibold text-slate-600 sm:inline-flex"
                        >
                            {{ resultsLabel }}
                        </Badge>
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-0.5 text-xs text-slate-400">
                                Search by plate number, vehicle type, body
                                number, or model.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <SelectContent class="rounded-xl">
                                ...
                                <SelectItem value="Jeepney" class="text-xs"
                                    >Jeepney</SelectItem
                                >
                                <SelectItem value="Mini Bus" class="text-xs"
                                    >Mini Bus</SelectItem
                                >
                                <SelectItem value="UV Express" class="text-xs"
        ...
        <AlertDialog v-model:open="activateDialogOpen">
            <AlertDialogContent class="rounded-2xl">
                ...
                <AlertDialogFooter>
                    <AlertDialogCancel
                        class="rounded-lg"
                        @click="activateDialog.vehicle = null"
                    >
                        Cancel
                    </AlertDialogCancel>
                    <AlertDialogAction
