      ...
      <Card>
        <div class="flex justify-between items-center p-4">
          <div>
            ...
            <p class="text-sm text-gray-500">List of all vehicle types in the system.</p>
          </div>
          ...
          <form @submit.prevent="updateVehicle">
            ...
            <div class="mt-4 space-y-4">
              <div>
                ...
                <InputError :message="editForm.errors.type_name" />
              </div>

              <div>
                <Label>Status</Label>
                <select v-model="editForm.is_active" class="w-full rounded-md border px-3 py-2 text-sm">
